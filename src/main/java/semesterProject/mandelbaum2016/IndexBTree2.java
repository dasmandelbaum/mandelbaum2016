...
//package edu.yu.cs.ds.fall2016.trees.binary;
 ...
 */
public class IndexBTree2<Key extends Comparable<Key>, Value>
{
	...
	private Entry[] entries = new Entry[IndexBTree2.MAX]; // the array of children
	private Node next;
	...
	public Entry(@SuppressWarnings("rawtypes") Comparable key, Object val, Node child)
	{
	    this.key = key;
	    this.val = val;
	    this.child = child;
	...
	if (currentNode.entryCount < IndexBTree2.MAX)
	{
    ...
    {
	Node newNode = new Node(IndexBTree2.MAX / 2);
	//by changing currentNode.entryCount, we will treat any value
	//at index higher than the new currentNode.entryCount as if
	//it doesn't exist
	currentNode.entryCount = IndexBTree2.MAX / 2;
	//copy top half of h into t
	for (int j = 0; j < IndexBTree2.MAX / 2; j++)
	{
	    newNode.entries[j] = currentNode.entries[IndexBTree2.MAX / 2 + j];
	}
	//external node
	if (height == 0)
	{
    ...
    {
    IndexBTree2<Integer, String> st = new IndexBTree2<Integer, String>();
	st.put(1, "one");
	st.put(2, "two");
	st.put(3, "three");
	st.put(4, "four");
